...
*/
     ...
     * \brief Constants to be passed as "mode" parameter in the Test_0_SetDriveMode() function.
     *  @{
     */
...
/* Interrupt constants */
#if defined(Test_0__INTSTAT)
/**
* \addtogroup group_constants
* @{
*/
    /** \addtogroup intrMode Interrupt constants
     * \brief Constants to be passed as "mode" parameter in Test_0_SetInterruptMode() function.
     *  @{
     */
        #define Test_0_INTR_NONE      (uint16)(0x0000u)
        #define Test_0_INTR_RISING    (uint16)(0x0001u)
        #define Test_0_INTR_FALLING   (uint16)(0x0002u)
        #define Test_0_INTR_BOTH      (uint16)(0x0003u) 
    /** @} intrMode */
/** @} group_constants */

    #define Test_0_INTR_MASK      (0x01u) 
#endif /* (Test_0__INTSTAT) */
...
/* SIO registers */
#if defined(Test_0__SIO_CFG)
    #define Test_0_SIO_HYST_EN        (* (reg8 *) Test_0__SIO_HYST_EN)
    #define Test_0_SIO_REG_HIFREQ     (* (reg8 *) Test_0__SIO_REG_HIFREQ)
    #define Test_0_SIO_CFG            (* (reg8 *) Test_0__SIO_CFG)
    #define Test_0_SIO_DIFF           (* (reg8 *) Test_0__SIO_DIFF)
#endif /* (Test_0__SIO_CFG) */
...
/* Interrupt Registers */
	...
	#define Test_0_0_INTTYPE_REG 		(* (reg8 *) Test_0__0__INTTYPE)
#endif /* (Test_0__INTSTAT) */

#endif /* CY_PSOC5A... */

#endif /*  CY_PINS_Test_0_H */
