// ======================================================================
// ce4950-term-project.v generated from TopDesign.cysch
// 02/17/2018 at 15:54
...
module CharLCD_v2_20_1 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("a3d0078b-52ec-4dde-b535-1b9b20f069ef/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module CapSense_CSD_v3_50_6 (
	...
	cy_psoc3_port_v1_0
		#(.width(2),
		  ...
		  .pin_aliases({"Right__BTN,Left_","_BTN"}),
		  .access_mode("HW_ONLY"),
		  .layout_mode("NONCONTIGUOUS"),
		  .port_mode("ANALOG"),
		  .intr_mode(4'b0000),
...
// Timer_v2_80(CaptureAlternatingFall=false, CaptureAlternatingRise=false, CaptureCount=2, CaptureCounterEnabled=false, CaptureInputEnabled=false, CaptureMode=0, CONTROL3=1, ControlRegRemoved=0, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, DeviceFamily=PSoC5, EnableMode=0, FF16=true, FF8=false, FixedFunction=true, FixedFunctionUsed=1, HWCaptureCounterEnabled=false, InterruptOnCapture=false, InterruptOnFIFOFull=false, InterruptOnTC=true, IntOnCapture=0, IntOnFIFOFull=0, IntOnTC=1, NumberOfCaptures=1, param45=1, Period=499, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, Resolution=16, RstStatusReplacementString=rstSts, RunMode=1, SiliconRevision=0, SoftwareCaptureModeEnabled=false, SoftwareTriggerModeEnabled=false, TriggerInputEnabled=false, TriggerMode=0, UDB16=false, UDB24=false, UDB32=false, UDB8=false, UDBControlReg=false, UsesHWEnable=0, VerilogSectionReplacementString=sT16, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=Timer_v2_80, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Rx_Timer, CY_INSTANCE_SHORT_NAME=Rx_Timer, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=80, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.1 Update 1, INSTANCE_NAME=Rx_Timer, )
...
module top ;
	...
	wire [0:0] tmpOE__CSMA_RX_net;
	wire [0:0] tmpIO_0__CSMA_RX_net;
	wire [0:0] tmpINTERRUPT_0__CSMA_RX_net;
	electrical [0:0] tmpSIOVREF__CSMA_RX_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .input_buffer_sel(2'b00))
		CSMA_RX
		 (.oe(tmpOE__CSMA_RX_net),
		  .y({1'b0}),
		  .fb({Net_484}),
		  .io({tmpIO_0__CSMA_RX_net[0:0]}),
		  .siovref(tmpSIOVREF__CSMA_RX_net),
		  .interrupt({tmpINTERRUPT_0__CSMA_RX_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__CSMA_RX_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__CSMA_TX_net;
	wire [0:0] tmpFB_0__CSMA_TX_net;
	wire [0:0] tmpIO_0__CSMA_TX_net;
	wire [0:0] tmpINTERRUPT_0__CSMA_TX_net;
	electrical [0:0] tmpSIOVREF__CSMA_TX_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		CSMA_TX
		 (.oe(tmpOE__CSMA_TX_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__CSMA_TX_net[0:0]}),
		  .io({tmpIO_0__CSMA_TX_net[0:0]}),
		  .siovref(tmpSIOVREF__CSMA_TX_net),
		  .interrupt({tmpINTERRUPT_0__CSMA_TX_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__CSMA_TX_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__CM_IDLE_FLAG_net;
	wire [0:0] tmpFB_0__CM_IDLE_FLAG_net;
	wire [0:0] tmpIO_0__CM_IDLE_FLAG_net;
	wire [0:0] tmpINTERRUPT_0__CM_IDLE_FLAG_net;
	electrical [0:0] tmpSIOVREF__CM_IDLE_FLAG_net;

	cy_psoc3_pins_v1_10
		#(.id("bc6200b4-090b-4a4b-a013-22a71cc32279"),
		  .drive_mode(3'b011),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		CM_IDLE_FLAG
		 (.oe(tmpOE__CM_IDLE_FLAG_net),
		  .y({Net_3}),
		  .fb({tmpFB_0__CM_IDLE_FLAG_net[0:0]}),
		  .io({tmpIO_0__CM_IDLE_FLAG_net[0:0]}),
		  .siovref(tmpSIOVREF__CM_IDLE_FLAG_net),
		  .interrupt({tmpINTERRUPT_0__CM_IDLE_FLAG_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__CM_IDLE_FLAG_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__CM_BUSY_FLAG_net;
	wire [0:0] tmpFB_0__CM_BUSY_FLAG_net;
	wire [0:0] tmpIO_0__CM_BUSY_FLAG_net;
	wire [0:0] tmpINTERRUPT_0__CM_BUSY_FLAG_net;
	electrical [0:0] tmpSIOVREF__CM_BUSY_FLAG_net;

	cy_psoc3_pins_v1_10
		#(.id("56cfdfa1-dd72-4d30-9255-832186bb5e92"),
		  .drive_mode(3'b011),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		CM_BUSY_FLAG
		 (.oe(tmpOE__CM_BUSY_FLAG_net),
		  .y({Net_4}),
		  .fb({tmpFB_0__CM_BUSY_FLAG_net[0:0]}),
		  .io({tmpIO_0__CM_BUSY_FLAG_net[0:0]}),
		  .siovref(tmpSIOVREF__CM_BUSY_FLAG_net),
		  .interrupt({tmpINTERRUPT_0__CM_BUSY_FLAG_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__CM_BUSY_FLAG_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__CM_COL_FLAG_net;
	wire [0:0] tmpFB_0__CM_COL_FLAG_net;
	wire [0:0] tmpIO_0__CM_COL_FLAG_net;
	wire [0:0] tmpINTERRUPT_0__CM_COL_FLAG_net;
	electrical [0:0] tmpSIOVREF__CM_COL_FLAG_net;

	cy_psoc3_pins_v1_10
		#(.id("c30ede01-908b-4dff-bab0-01191f49297d"),
		  .drive_mode(3'b011),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		CM_COL_FLAG
		 (.oe(tmpOE__CM_COL_FLAG_net),
		  .y({Net_470}),
		  .fb({tmpFB_0__CM_COL_FLAG_net[0:0]}),
		  .io({tmpIO_0__CM_COL_FLAG_net[0:0]}),
		  .siovref(tmpSIOVREF__CM_COL_FLAG_net),
		  .interrupt({tmpINTERRUPT_0__CM_COL_FLAG_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__CM_COL_FLAG_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    begin : demux_1
        ...
        always @(Net_10 or Net_24)
        begin
            case (Net_24[1:0])
                2'b00:
                begin
                    tmp__demux_1_0_reg = Net_10;
                ...
                begin
                    ...
                    tmp__demux_1_1_reg = 1'b0;
                    tmp__demux_1_2_reg = 1'b0;
                    tmp__demux_1_3_reg = Net_10;
                end
            endcase
        end
        assign Net_12 = tmp__demux_1_0_reg;
        assign Net_3 = tmp__demux_1_1_reg;
        assign Net_4 = tmp__demux_1_2_reg;
        assign Net_470 = tmp__demux_1_3_reg;
    end
    // -- De Mux end --

    assign Net_10 = 1'h1;

	wire [0:0] tmpOE__CM_INIT_FLAG_net;
	wire [0:0] tmpFB_0__CM_INIT_FLAG_net;
	wire [0:0] tmpIO_0__CM_INIT_FLAG_net;
	wire [0:0] tmpINTERRUPT_0__CM_INIT_FLAG_net;
	electrical [0:0] tmpSIOVREF__CM_INIT_FLAG_net;

	cy_psoc3_pins_v1_10
		#(.id("266d8aa8-9a06-4826-ad9b-ca59a56f41b3"),
		  .drive_mode(3'b011),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		CM_INIT_FLAG
		 (.oe(tmpOE__CM_INIT_FLAG_net),
		  .y({Net_12}),
		  .fb({tmpFB_0__CM_INIT_FLAG_net[0:0]}),
		  .io({tmpIO_0__CM_INIT_FLAG_net[0:0]}),
		  .siovref(tmpSIOVREF__CM_INIT_FLAG_net),
		  .interrupt({tmpINTERRUPT_0__CM_INIT_FLAG_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__CM_INIT_FLAG_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    CyControlReg_v1_80 CM_State_Reg (
        .control_1(Net_13),
        .control_2(Net_14),
        .control_3(Net_15),
        .control_0(Net_16),
        ...
        .clock(1'b0),
        .reset(1'b0),
        .control_bus(Net_24[1:0]));
    defparam CM_State_Reg.Bit0Mode = 0;
    defparam CM_State_Reg.Bit1Mode = 0;
    defparam CM_State_Reg.Bit2Mode = 0;
    defparam CM_State_Reg.Bit3Mode = 0;
    defparam CM_State_Reg.Bit4Mode = 0;
    defparam CM_State_Reg.Bit5Mode = 0;
    defparam CM_State_Reg.Bit6Mode = 0;
    defparam CM_State_Reg.Bit7Mode = 0;
    defparam CM_State_Reg.BitValue = 0;
    defparam CM_State_Reg.BusDisplay = 1;
    defparam CM_State_Reg.ExtrReset = 0;
    defparam CM_State_Reg.NumOutputs = 2;
    ...
    Timer_v2_80_0 CM_Timer (
        ...
        .tc(Net_361),
        .clock(Net_337));
    defparam CM_Timer.CaptureCount = 2;
    defparam CM_Timer.CaptureCounterEnabled = 0;
    defparam CM_Timer.DeviceFamily = "PSoC5";
    defparam CM_Timer.InterruptOnCapture = 0;
    defparam CM_Timer.InterruptOnTC = 1;
    defparam CM_Timer.Resolution = 16;
    defparam CM_Timer.SiliconRevision = "0";

    CharLCD_v2_20_1 LCD ();

    CyStatusReg_v1_90 CM_Test_State_Reg (
        .status_0(Net_12),
        .status_1(Net_3),
        .status_2(Net_4),
        .status_3(Net_470),
        ...
        .intr(Net_191),
        .status_bus(8'b0));
    defparam CM_Test_State_Reg.Bit0Mode = 1;
    defparam CM_Test_State_Reg.Bit1Mode = 1;
    defparam CM_Test_State_Reg.Bit2Mode = 1;
    defparam CM_Test_State_Reg.Bit3Mode = 1;
    defparam CM_Test_State_Reg.Bit4Mode = 0;
    defparam CM_Test_State_Reg.Bit5Mode = 0;
    defparam CM_Test_State_Reg.Bit6Mode = 0;
    defparam CM_Test_State_Reg.Bit7Mode = 0;
    defparam CM_Test_State_Reg.BusDisplay = 0;
    defparam CM_Test_State_Reg.Interrupt = 0;
    defparam CM_Test_State_Reg.MaskValue = 0;
    defparam CM_Test_State_Reg.NumInputs = 4;
    ...
    assign Net_312 = ~Net_484;

    CyControlReg_v1_80 CM_Timer_Trigger (
        .control_1(Net_327),
        .control_2(Net_328),
        .control_3(Net_329),
        .control_0(Net_38),
        ...
        .clock(1'b0),
        .reset(1'b0));
    defparam CM_Timer_Trigger.Bit0Mode = 0;
    defparam CM_Timer_Trigger.Bit1Mode = 0;
    defparam CM_Timer_Trigger.Bit2Mode = 0;
    defparam CM_Timer_Trigger.Bit3Mode = 0;
    defparam CM_Timer_Trigger.Bit4Mode = 0;
    defparam CM_Timer_Trigger.Bit5Mode = 0;
    defparam CM_Timer_Trigger.Bit6Mode = 0;
    defparam CM_Timer_Trigger.Bit7Mode = 0;
    defparam CM_Timer_Trigger.BitValue = 1;
    defparam CM_Timer_Trigger.BusDisplay = 0;
    defparam CM_Timer_Trigger.ExtrReset = 0;
    defparam CM_Timer_Trigger.NumOutputs = 1;
    ...
    defparam Rx_Timer.Resolution = 16;
    ...
    CyControlReg_v1_80 Rx_Timer_Trigger (
        .control_1(Net_458),
        .control_2(Net_459),
        .control_3(Net_460),
        .control_0(Net_431),
        ...
        .clock(1'b0),
        .reset(1'b0));
    defparam Rx_Timer_Trigger.Bit0Mode = 0;
    defparam Rx_Timer_Trigger.Bit1Mode = 0;
    defparam Rx_Timer_Trigger.Bit2Mode = 0;
    defparam Rx_Timer_Trigger.Bit3Mode = 0;
    defparam Rx_Timer_Trigger.Bit4Mode = 0;
    defparam Rx_Timer_Trigger.Bit5Mode = 0;
    defparam Rx_Timer_Trigger.Bit6Mode = 0;
    defparam Rx_Timer_Trigger.Bit7Mode = 0;
    defparam Rx_Timer_Trigger.BitValue = 1;
    defparam Rx_Timer_Trigger.BusDisplay = 0;
    defparam Rx_Timer_Trigger.ExtrReset = 0;
    defparam Rx_Timer_Trigger.NumOutputs = 1;
    ...
    CyControlReg_v1_80 Tx_Timer_Trigger (
        .control_1(Net_471),
        .control_2(Net_472),
        .control_3(Net_473),
        .control_0(Net_380),
        ...
        .clock(1'b0),
        .reset(1'b0));
    defparam Tx_Timer_Trigger.Bit0Mode = 0;
    defparam Tx_Timer_Trigger.Bit1Mode = 0;
    defparam Tx_Timer_Trigger.Bit2Mode = 0;
    defparam Tx_Timer_Trigger.Bit3Mode = 0;
    defparam Tx_Timer_Trigger.Bit4Mode = 0;
    defparam Tx_Timer_Trigger.Bit5Mode = 0;
    defparam Tx_Timer_Trigger.Bit6Mode = 0;
    defparam Tx_Timer_Trigger.Bit7Mode = 0;
    defparam Tx_Timer_Trigger.BitValue = 1;
    defparam Tx_Timer_Trigger.BusDisplay = 0;
    defparam Tx_Timer_Trigger.ExtrReset = 0;
    defparam Tx_Timer_Trigger.NumOutputs = 1;
