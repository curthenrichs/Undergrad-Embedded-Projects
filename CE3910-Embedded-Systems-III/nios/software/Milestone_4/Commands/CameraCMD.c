...
//todo apply filter on image to remove stray pixels
//todo tune thresholding
 ...
 */
#define TOLERANCE 0x03

//todo comment these
// Error threshold to prevent servo from hunting
#define MIN_SERVO_COMMAND_X 5
#define MIN_SERVO_COMMAND_Y 10
