...
#if !defined(CY_TIMER_Watchdog_Timer_H)
#define CY_TIMER_Watchdog_Timer_H
...
#define Watchdog_Timer_INIT_PERIOD             19999u
#define Watchdog_Timer_INIT_CAPTURE_MODE       ((uint8)((uint8)1u << Watchdog_Timer_CTRL_CAP_MODE_SHIFT))
#define Watchdog_Timer_INIT_TRIGGER_MODE       ((uint8)((uint8)0u << Watchdog_Timer_CTRL_TRIG_MODE_SHIFT))
#if (Watchdog_Timer_UsingFixedFunction)
    #define Watchdog_Timer_INIT_INTERRUPT_MODE (((uint8)((uint8)1u << Watchdog_Timer_STATUS_TC_INT_MASK_SHIFT)) | \
...
#endif  /* CY_TIMER_Watchdog_Timer_H */
