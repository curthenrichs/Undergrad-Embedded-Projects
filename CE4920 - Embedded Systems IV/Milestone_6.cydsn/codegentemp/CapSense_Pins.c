...
{
    /* Set pins drive mode */
    CyPins_SetPinDriveMode(CapSense_PortCH0__Slider_e0__LS, mode);
    CyPins_SetPinDriveMode(CapSense_PortCH0__Slider_e1__LS, mode);
    CyPins_SetPinDriveMode(CapSense_PortCH0__Slider_e2__LS, mode);
    CyPins_SetPinDriveMode(CapSense_PortCH0__Slider_e3__LS, mode);
    CyPins_SetPinDriveMode(CapSense_PortCH0__Slider_e4__LS, mode);
    CyPins_SetPinDriveMode(CapSense_PortCH0__Right__BTN, mode);
    CyPins_SetPinDriveMode(CapSense_PortCH0__Left__BTN, mode);
