...
uint8 Button_CompCH0_initVar = 0u;

/* Internal functions definitoin */
static void Button_CompCH0_trimAdjust(uint8 nibble) ;

/* static Button_CompCH0_backupStruct  Button_CompCH0_backup; */
#if (CY_PSOC5A)
    static Button_CompCH0_LOWPOWER_BACKUP_STRUCT  Button_CompCH0_lowPowerBackup;
#endif /* CY_PSOC5A */

/* variable to decide whether or not to restore the control register in 
   Enable() API for PSoC5A only */
#if (CY_PSOC5A)
    static uint8 Button_CompCH0_restoreReg = 0u;
#endif /* CY_PSOC5A */


/*******************************************************************************
* Function Name: Button_CompCH0_Init
********************************************************************************
*
* Summary:
...
void Button_CompCH0_Init(void) 
{
    ...
    Button_CompCH0_SetSpeed(Button_CompCH0_DEFAULT_SPEED);

    /* Set default Hysteresis */
    #if ( Button_CompCH0_DEFAULT_HYSTERESIS == 0u )
        Button_CompCH0_CR |= Button_CompCH0_HYST_OFF;
    #else
        Button_CompCH0_CR &= (uint8)(~Button_CompCH0_HYST_OFF);
    #endif /* Button_CompCH0_DEFAULT_HYSTERESIS == 0u */
    /* Power down override feature is not supported for PSoC5A. */
    #if (CY_PSOC3 || CY_PSOC5LP)
        /* Set default Power Down Override */
        #if ( Button_CompCH0_DEFAULT_PWRDWN_OVRD == 0u )
            Button_CompCH0_CR &= (uint8)(~Button_CompCH0_PWRDWN_OVRD);
        #else 
            Button_CompCH0_CR |= Button_CompCH0_PWRDWN_OVRD;
        #endif /* Button_CompCH0_DEFAULT_PWRDWN_OVRD == 0u */
    #endif /* CY_PSOC3 || CY_PSOC5LP */
    
    /* Set mux always on logic */
    Button_CompCH0_CR |= Button_CompCH0_MX_AO;

    /* Set default sync */
    Button_CompCH0_CLK &= (uint8)(~Button_CompCH0_SYNCCLK_MASK);
    #if ( Button_CompCH0_DEFAULT_BYPASS_SYNC == 0u )
        Button_CompCH0_CLK |= Button_CompCH0_SYNC_CLK_EN;
    #else
        Button_CompCH0_CLK |= Button_CompCH0_BYPASS_SYNC;
    #endif /* Button_CompCH0_DEFAULT_BYPASS_SYNC == 0u */
}


/*******************************************************************************
* Function Name: Button_CompCH0_Enable
********************************************************************************
*
* Summary:
...
{
    Button_CompCH0_PWRMGR |= Button_CompCH0_ACT_PWR_EN;
    Button_CompCH0_STBY_PWRMGR |= Button_CompCH0_STBY_PWR_EN;
     
     /* This is to restore the value of register CR which is saved 
    in prior to the modification in stop() API */
    #if (CY_PSOC5A)
        if(Button_CompCH0_restoreReg == 1u)
        {
            Button_CompCH0_CR = Button_CompCH0_lowPowerBackup.compCRReg;

            /* Clear the flag */
            Button_CompCH0_restoreReg = 0u;
        }
    #endif /* CY_PSOC5A */
}
...
/*******************************************************************************
* Function Name: Button_CompCH0_Start
********************************************************************************
*
* Summary:
...
*
* Global variables:
*  Button_CompCH0_initVar: Is modified when this function is called for the 
...
void Button_CompCH0_Start(void) 
{
    ...
    if ( Button_CompCH0_initVar == 0u )
    {
        Button_CompCH0_Init();
        
        Button_CompCH0_initVar = 1u;
    }   
...
/*******************************************************************************
* Function Name: Button_CompCH0_Stop
********************************************************************************
*
* Summary:
...
void Button_CompCH0_Stop(void) 
{
    ...
    Button_CompCH0_PWRMGR &= (uint8)(~Button_CompCH0_ACT_PWR_EN);
    Button_CompCH0_STBY_PWRMGR &= (uint8)(~Button_CompCH0_STBY_PWR_EN);
    
    #if (CY_PSOC5A)
        /* Enable the variable */
        Button_CompCH0_restoreReg = 1u;

        /* Save the control register before clearing it */
        Button_CompCH0_lowPowerBackup.compCRReg = Button_CompCH0_CR;
        Button_CompCH0_CR = Button_CompCH0_COMP_REG_CLR;
    #endif /* CY_PSOC5A */
}


/*******************************************************************************
* Function Name: Button_CompCH0_SetSpeed
********************************************************************************
*
* Summary:
...
void Button_CompCH0_SetSpeed(uint8 speed) 
{
    ...
    Button_CompCH0_CR = (Button_CompCH0_CR & (uint8)(~Button_CompCH0_PWR_MODE_MASK)) |
                           (speed & Button_CompCH0_PWR_MODE_MASK);

    /* Set trim value for high speed comparator */
    if(speed == Button_CompCH0_HIGHSPEED)
    {
        /* PSoC5A */
        #if (CY_PSOC5A)
            Button_CompCH0_TR = Button_CompCH0_HS_TRIM_TR0;
        #endif /* CY_PSOC5A */
        
        /* PSoC3, PSoC5LP or later */
        #if (CY_PSOC3 || CY_PSOC5LP) 
            Button_CompCH0_TR0 = Button_CompCH0_HS_TRIM_TR0;
            Button_CompCH0_TR1 = Button_CompCH0_HS_TRIM_TR1;
        #endif /* CY_PSOC3 || CY_PSOC5LP */
    }
    else
    {
    /* PSoC5A */
        #if (CY_PSOC5A)
            Button_CompCH0_TR = Button_CompCH0_LS_TRIM_TR0;
        #endif /* CY_PSOC5A */
        
        /* PSoC3, PSoC5LP or later */
        #if (CY_PSOC3 || CY_PSOC5LP) 
            Button_CompCH0_TR0 = Button_CompCH0_LS_TRIM_TR0;
            Button_CompCH0_TR1 = Button_CompCH0_LS_TRIM_TR1;
        #endif /* CY_PSOC3 || CY_PSOC5LP */
    }
...
/*******************************************************************************
* Function Name: Button_CompCH0_GetCompare
********************************************************************************
*
* Summary:
...
{
    return( Button_CompCH0_WRK & Button_CompCH0_CMP_OUT_MASK);
}


/*******************************************************************************
* Function Name: Button_CompCH0_trimAdjust
********************************************************************************
*
* Summary:
...
static void Button_CompCH0_trimAdjust(uint8 nibble) 
{
    ...
    cmpState = Button_CompCH0_WRK & Button_CompCH0_CMP_OUT_MASK;
    ...
    {    
        ...
        if ( cmpState != 0u )
        {
            /* PSoC5A */
            #if (CY_PSOC5A)
                Button_CompCH0_TR |= Button_CompCH0_CMP_TRIM1_DIR;
            #endif /* CY_PSOC5A */
            
            /* PSoC3, PSoC5LP or later */
            #if (CY_PSOC3 || CY_PSOC5LP)
                Button_CompCH0_TR0 |= Button_CompCH0_CMP_TR0_DIR;
            #endif /* CY_PSOC3 || CY_PSOC5LP */
        }
    }
    else
    {
        ...
        if ( cmpState == 0u )
        {
            /* PSoC5A */
            #if (CY_PSOC5A)
                Button_CompCH0_TR |= Button_CompCH0_CMP_TRIM2_DIR; 
            #endif /* CY_PSOC5A */
            
            /* PSoC3, PSoC5LP or later */
            #if (CY_PSOC3 || CY_PSOC5LP)
                Button_CompCH0_TR1 |= Button_CompCH0_CMP_TR1_DIR;
            #endif /* CY_PSOC3 || CY_PSOC5LP */
        }
    }
    ...
    for ( trimCnt = 0u; trimCnt < trimCntMax; trimCnt++ )
	{
        if (nibble == 0u)
        {
            /* PSoC5A */
            #if (CY_PSOC5A)
                Button_CompCH0_TR += 1u;
            #endif /* CY_PSOC5A */
            
            /* PSoC3, PSoC5LP or later */
            #if (CY_PSOC3 || CY_PSOC5LP)
                Button_CompCH0_TR0 += 1u;
            #endif /* CY_PSOC3 || CY_PSOC5LP */
        }
        else
        {
            /* PSoC5A */
            #if (CY_PSOC5A)
                Button_CompCH0_TR += 0x10u;
            #endif /* CY_PSOC5A */
            
            /* PSoC3, PSoC5LP or later */
            #if (CY_PSOC3 || CY_PSOC5LP)
                Button_CompCH0_TR1 += 1u;
            #endif /* CY_PSOC3 || CY_PSOC5LP */
        }
        ...
        if ((Button_CompCH0_WRK & Button_CompCH0_CMP_OUT_MASK) != cmpState)
        {
...
/*******************************************************************************
* Function Name: Button_CompCH0_ZeroCal
********************************************************************************
*
* Summary:
...
uint16 Button_CompCH0_ZeroCal(void) 
{
    ...
    tmpSW0 = Button_CompCH0_SW0;
    tmpSW2 = Button_CompCH0_SW2;
    tmpSW3 = Button_CompCH0_SW3;

     /* Clear routing for inP, retain routing for inN */
    Button_CompCH0_SW0 = 0x00u;
    Button_CompCH0_SW2 = 0x00u;
    Button_CompCH0_SW3 = tmpSW3 & (uint8)(~Button_CompCH0_CMP_SW3_INPCTL_MASK);

    /* Preserve original configuration
     * - turn off Hysteresis
     * - set calibration bit - shorts inN to inP
    */
    tmpCR = Button_CompCH0_CR;
    Button_CompCH0_CR |= (Button_CompCH0_CAL_ON | Button_CompCH0_HYST_OFF);
    
    /* Write default low values to trim register - no offset adjust */
    /* PSoC5A */
    #if (CY_PSOC5A)
        Button_CompCH0_TR = Button_CompCH0_DEFAULT_CMP_TRIM;
    #endif /* CY_PSOC5A */
    
    /* PSoC3, PSoC5LP or later */
    #if (CY_PSOC3 || CY_PSOC5LP)
        Button_CompCH0_TR0 = Button_CompCH0_DEFAULT_CMP_TRIM;
        Button_CompCH0_TR1 = Button_CompCH0_DEFAULT_CMP_TRIM;
    #endif /* CY_PSOC3 || CY_PSOC5LP */
	
	/* Two phase trim - slow modes, one phase trim - for fast */ 
    if ( (Button_CompCH0_CR & Button_CompCH0_PWR_MODE_MASK) == Button_CompCH0_PWR_MODE_FAST)
    {
        Button_CompCH0_trimAdjust(0u);
    }
    else /* default to trim for fast modes */
    {
        Button_CompCH0_trimAdjust(1u);
		Button_CompCH0_trimAdjust(0u);
    }
   
    /* Restore Config Register */
    Button_CompCH0_CR = tmpCR;
    
    /* Restore routing registers for inP */
    Button_CompCH0_SW0 = tmpSW0;
    Button_CompCH0_SW2 = tmpSW2;
    Button_CompCH0_SW3 = tmpSW3;
    
    /* PSoC5A */
    #if (CY_PSOC5A)
        return (uint16) Button_CompCH0_TR;
    #endif /* CY_PSOC5A */
    
    /* PSoC3, PSoC5LP or later */
    #if (CY_PSOC3 || CY_PSOC5LP)
        return ((uint16)((uint16)Button_CompCH0_TR1 << 8u) | (Button_CompCH0_TR0));        
    #endif /* CY_PSOC3 || CY_PSOC5LP */
}


/*******************************************************************************
* Function Name: Button_CompCH0_LoadTrim
********************************************************************************
*
* Summary:
...
void Button_CompCH0_LoadTrim(uint16 trimVal) 
{
    ...
    /*******************************************************************************
    * Function Name: Button_CompCH0_PwrDwnOverrideEnable
    ********************************************************************************
    *
    * Summary:
    ...
    *******************************************************************************/
    ...
    /*******************************************************************************
    * Function Name: Button_CompCH0_PwrDwnOverrideDisable
    ********************************************************************************
    *
    * Summary:
