...
#define BS_IOPINS0_0_VAL ((const uint8 CYFAR *)0x480007D8u)

/* IOPINS0_7 Address: CYREG_PRT12_DM0 Size (bytes): 8 */
#define BS_IOPINS0_7_VAL ((const uint8 CYFAR *)0x480007E0u)

/* IOPINS0_8 Address: CYREG_PRT15_DR Size (bytes): 10 */
#define BS_IOPINS0_8_VAL ((const uint8 CYFAR *)0x480007E8u)

/* IOPINS0_1 Address: CYREG_PRT1_DM0 Size (bytes): 8 */
#define BS_IOPINS0_1_VAL ((const uint8 CYFAR *)0x480007F4u)

/* IOPINS0_2 Address: CYREG_PRT2_DM0 Size (bytes): 8 */
#define BS_IOPINS0_2_VAL ((const uint8 CYFAR *)0x480007FCu)

/* IOPINS0_3 Address: CYREG_PRT3_DM0 Size (bytes): 8 */
#define BS_IOPINS0_3_VAL ((const uint8 CYFAR *)0x48000804u)

/* IOPINS0_5 Address: CYREG_PRT5_DM0 Size (bytes): 8 */
#define BS_IOPINS0_5_VAL ((const uint8 CYFAR *)0x4800080Cu)

/* IOPINS0_6 Address: CYREG_PRT6_DM0 Size (bytes): 8 */
#define BS_IOPINS0_6_VAL ((const uint8 CYFAR *)0x48000814u)

/* CYDEV_CLKDIST_ACFG0_CFG0 Address: CYREG_CLKDIST_ACFG0_CFG0 Size (bytes): 4 */
#define BS_CYDEV_CLKDIST_ACFG0_CFG0_VAL ((const uint8 CYFAR *)0x4800081Cu)
...
static void ClockSetup(void)
{
	...
	CY_SET_XTND_REG16((void CYFAR *)(CYREG_CLKDIST_DCFG5_CFG0), 0x4E1Fu);
...
static void AnalogSetDefault(void)
{
	...
	CY_SET_XTND_REG8((void CYFAR *)CYREG_CMP3_SW0, 0xA0u);
...
static uint8 CYXDATA * const CYCODE HB_MUX__outerAddr[2] = {
	(uint8 CYXDATA *)CYREG_DAC2_SW0, 
	(uint8 CYXDATA *)CYREG_PRT0_AG, 
};

static const uint8 CYCODE HB_MUX__outerMask[2] = {
	0x10u, 
	0x10u, 
};

static uint8 CYXDATA * const CYCODE HB_MUX__innerAddr[1] = {
	(uint8 CYXDATA *)CYREG_SC0_SW0, 
};

static const uint8 CYCODE HB_MUX__innerMask[1] = {
	0x10u, 
};

static const uint8 CYCODE HB_MUX__innerMap[2] = {
	0u, 
	0u, 
};

static uint8 HB_MUX__armsEnabled = 0u;
static uint8 HB_MUX__refCnt[] = {0u};

/*******************************************************************************
* Function Name: HB_MUX_Set
********************************************************************************
* Summary:
...
*
*******************************************************************************/
void HB_MUX_Set(uint8 channel)
{
	uint8 i;
	uint8 channelMask = (1UL << channel);
	if ((channel < 2u) && ((HB_MUX__armsEnabled & channelMask) == ((uint32)0u)))
	{
		HB_MUX__armsEnabled |= channelMask;
		*HB_MUX__outerAddr[channel] |= HB_MUX__outerMask[channel];
		i = HB_MUX__innerMap[channel];
		if (HB_MUX__refCnt[i] == 0u)
		{
			*HB_MUX__innerAddr[i] |= HB_MUX__innerMask[i];
		}
		HB_MUX__refCnt[i]++;
	}
}
...
*
*******************************************************************************/
void HB_MUX_Unset(uint8 channel)
{
	uint8 i;
	uint8 channelMask = (1UL << channel);
	if ((channel < 2u) && ((HB_MUX__armsEnabled & channelMask) != ((uint32)0u)))
	{
		HB_MUX__armsEnabled &= (uint8)~channelMask;
		*HB_MUX__outerAddr[channel] &= (uint8)~HB_MUX__outerMask[channel];
		i = HB_MUX__innerMap[channel];
		HB_MUX__refCnt[i]--;
		if (HB_MUX__refCnt[i] == 0)
		{
			*HB_MUX__innerAddr[i] &= (uint8)~HB_MUX__innerMask[i];
		}
	}
}
...
void cyfitter_cfg(void)
{
...

	{
		...
		CY_SET_XTND_REG32((void CYFAR *)(CYREG_B1_P4_U1_CFG24), 0x84040404u);
