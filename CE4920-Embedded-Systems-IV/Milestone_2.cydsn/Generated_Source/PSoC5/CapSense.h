...
/* Define Sensors */
#define CapSense_SENSOR_RIGHT__BTN    (0u)
#define CapSense_SENSOR_LEFT__BTN    (1u)
#define CapSense_SENSOR_SLIDER_E0__LS    (2u)
#define CapSense_SENSOR_SLIDER_E1__LS    (3u)
#define CapSense_SENSOR_SLIDER_E2__LS    (4u)
#define CapSense_SENSOR_SLIDER_E3__LS    (5u)
#define CapSense_SENSOR_SLIDER_E4__LS    (6u)
