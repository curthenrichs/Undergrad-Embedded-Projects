...
#define CASUAL_MOTOR_RATE   1 //! Casual profile PWM rate
#define MODERATE_MOTOR_RATE 1 //! Moderate profile PWM rate
#define INTENSE_MOTOR_RATE  1 //! Intense profile PWM rate
#define EXTREME_MOTOR_RATE  1 //! Extreme profile PWM rate
