...
uint8 Slider_CompCH0_initVar = 0u;

/* Internal functions definitoin */
static void Slider_CompCH0_trimAdjust(uint8 nibble) ;

/* static Slider_CompCH0_backupStruct  Slider_CompCH0_backup; */
#if (CY_PSOC5A)
    static Slider_CompCH0_LOWPOWER_BACKUP_STRUCT  Slider_CompCH0_lowPowerBackup;
#endif /* CY_PSOC5A */

/* variable to decide whether or not to restore the control register in 
   Enable() API for PSoC5A only */
#if (CY_PSOC5A)
    static uint8 Slider_CompCH0_restoreReg = 0u;
#endif /* CY_PSOC5A */


/*******************************************************************************
* Function Name: Slider_CompCH0_Init
********************************************************************************
*
* Summary:
...
void Slider_CompCH0_Init(void) 
{
    ...
    Slider_CompCH0_SetSpeed(Slider_CompCH0_DEFAULT_SPEED);

    /* Set default Hysteresis */
    #if ( Slider_CompCH0_DEFAULT_HYSTERESIS == 0u )
        Slider_CompCH0_CR |= Slider_CompCH0_HYST_OFF;
    #else
        Slider_CompCH0_CR &= (uint8)(~Slider_CompCH0_HYST_OFF);
    #endif /* Slider_CompCH0_DEFAULT_HYSTERESIS == 0u */
    /* Power down override feature is not supported for PSoC5A. */
    #if (CY_PSOC3 || CY_PSOC5LP)
        /* Set default Power Down Override */
        #if ( Slider_CompCH0_DEFAULT_PWRDWN_OVRD == 0u )
            Slider_CompCH0_CR &= (uint8)(~Slider_CompCH0_PWRDWN_OVRD);
        #else 
            Slider_CompCH0_CR |= Slider_CompCH0_PWRDWN_OVRD;
        #endif /* Slider_CompCH0_DEFAULT_PWRDWN_OVRD == 0u */
    #endif /* CY_PSOC3 || CY_PSOC5LP */
    
    /* Set mux always on logic */
    Slider_CompCH0_CR |= Slider_CompCH0_MX_AO;

    /* Set default sync */
    Slider_CompCH0_CLK &= (uint8)(~Slider_CompCH0_SYNCCLK_MASK);
    #if ( Slider_CompCH0_DEFAULT_BYPASS_SYNC == 0u )
        Slider_CompCH0_CLK |= Slider_CompCH0_SYNC_CLK_EN;
    #else
        Slider_CompCH0_CLK |= Slider_CompCH0_BYPASS_SYNC;
    #endif /* Slider_CompCH0_DEFAULT_BYPASS_SYNC == 0u */
}


/*******************************************************************************
* Function Name: Slider_CompCH0_Enable
********************************************************************************
*
* Summary:
...
{
    Slider_CompCH0_PWRMGR |= Slider_CompCH0_ACT_PWR_EN;
    Slider_CompCH0_STBY_PWRMGR |= Slider_CompCH0_STBY_PWR_EN;
     
     /* This is to restore the value of register CR which is saved 
    in prior to the modification in stop() API */
    #if (CY_PSOC5A)
        if(Slider_CompCH0_restoreReg == 1u)
        {
            Slider_CompCH0_CR = Slider_CompCH0_lowPowerBackup.compCRReg;

            /* Clear the flag */
            Slider_CompCH0_restoreReg = 0u;
        }
    #endif /* CY_PSOC5A */
}
...
/*******************************************************************************
* Function Name: Slider_CompCH0_Start
********************************************************************************
*
* Summary:
...
*
* Global variables:
*  Slider_CompCH0_initVar: Is modified when this function is called for the 
...
void Slider_CompCH0_Start(void) 
{
    ...
    if ( Slider_CompCH0_initVar == 0u )
    {
        Slider_CompCH0_Init();
        
        Slider_CompCH0_initVar = 1u;
    }   
...
/*******************************************************************************
* Function Name: Slider_CompCH0_Stop
********************************************************************************
*
* Summary:
...
void Slider_CompCH0_Stop(void) 
{
    ...
    Slider_CompCH0_PWRMGR &= (uint8)(~Slider_CompCH0_ACT_PWR_EN);
    Slider_CompCH0_STBY_PWRMGR &= (uint8)(~Slider_CompCH0_STBY_PWR_EN);
    
    #if (CY_PSOC5A)
        /* Enable the variable */
        Slider_CompCH0_restoreReg = 1u;

        /* Save the control register before clearing it */
        Slider_CompCH0_lowPowerBackup.compCRReg = Slider_CompCH0_CR;
        Slider_CompCH0_CR = Slider_CompCH0_COMP_REG_CLR;
    #endif /* CY_PSOC5A */
}


/*******************************************************************************
* Function Name: Slider_CompCH0_SetSpeed
********************************************************************************
*
* Summary:
...
void Slider_CompCH0_SetSpeed(uint8 speed) 
{
    ...
    Slider_CompCH0_CR = (Slider_CompCH0_CR & (uint8)(~Slider_CompCH0_PWR_MODE_MASK)) |
                           (speed & Slider_CompCH0_PWR_MODE_MASK);

    /* Set trim value for high speed comparator */
    if(speed == Slider_CompCH0_HIGHSPEED)
    {
        /* PSoC5A */
        #if (CY_PSOC5A)
            Slider_CompCH0_TR = Slider_CompCH0_HS_TRIM_TR0;
        #endif /* CY_PSOC5A */
        
        /* PSoC3, PSoC5LP or later */
        #if (CY_PSOC3 || CY_PSOC5LP) 
            Slider_CompCH0_TR0 = Slider_CompCH0_HS_TRIM_TR0;
            Slider_CompCH0_TR1 = Slider_CompCH0_HS_TRIM_TR1;
        #endif /* CY_PSOC3 || CY_PSOC5LP */
    }
    else
    {
    /* PSoC5A */
        #if (CY_PSOC5A)
            Slider_CompCH0_TR = Slider_CompCH0_LS_TRIM_TR0;
        #endif /* CY_PSOC5A */
        
        /* PSoC3, PSoC5LP or later */
        #if (CY_PSOC3 || CY_PSOC5LP) 
            Slider_CompCH0_TR0 = Slider_CompCH0_LS_TRIM_TR0;
            Slider_CompCH0_TR1 = Slider_CompCH0_LS_TRIM_TR1;
        #endif /* CY_PSOC3 || CY_PSOC5LP */
    }
...
/*******************************************************************************
* Function Name: Slider_CompCH0_GetCompare
********************************************************************************
*
* Summary:
...
{
    return( Slider_CompCH0_WRK & Slider_CompCH0_CMP_OUT_MASK);
}


/*******************************************************************************
* Function Name: Slider_CompCH0_trimAdjust
********************************************************************************
*
* Summary:
...
static void Slider_CompCH0_trimAdjust(uint8 nibble) 
{
    ...
    cmpState = Slider_CompCH0_WRK & Slider_CompCH0_CMP_OUT_MASK;
    ...
    {    
        ...
        if ( cmpState != 0u )
        {
            /* PSoC5A */
            #if (CY_PSOC5A)
                Slider_CompCH0_TR |= Slider_CompCH0_CMP_TRIM1_DIR;
            #endif /* CY_PSOC5A */
            
            /* PSoC3, PSoC5LP or later */
            #if (CY_PSOC3 || CY_PSOC5LP)
                Slider_CompCH0_TR0 |= Slider_CompCH0_CMP_TR0_DIR;
            #endif /* CY_PSOC3 || CY_PSOC5LP */
        }
    }
    else
    {
        ...
        if ( cmpState == 0u )
        {
            /* PSoC5A */
            #if (CY_PSOC5A)
                Slider_CompCH0_TR |= Slider_CompCH0_CMP_TRIM2_DIR; 
            #endif /* CY_PSOC5A */
            
            /* PSoC3, PSoC5LP or later */
            #if (CY_PSOC3 || CY_PSOC5LP)
                Slider_CompCH0_TR1 |= Slider_CompCH0_CMP_TR1_DIR;
            #endif /* CY_PSOC3 || CY_PSOC5LP */
        }
    }
    ...
    for ( trimCnt = 0u; trimCnt < trimCntMax; trimCnt++ )
	{
        if (nibble == 0u)
        {
            /* PSoC5A */
            #if (CY_PSOC5A)
                Slider_CompCH0_TR += 1u;
            #endif /* CY_PSOC5A */
            
            /* PSoC3, PSoC5LP or later */
            #if (CY_PSOC3 || CY_PSOC5LP)
                Slider_CompCH0_TR0 += 1u;
            #endif /* CY_PSOC3 || CY_PSOC5LP */
        }
        else
        {
            /* PSoC5A */
            #if (CY_PSOC5A)
                Slider_CompCH0_TR += 0x10u;
            #endif /* CY_PSOC5A */
            
            /* PSoC3, PSoC5LP or later */
            #if (CY_PSOC3 || CY_PSOC5LP)
                Slider_CompCH0_TR1 += 1u;
            #endif /* CY_PSOC3 || CY_PSOC5LP */
        }
        ...
        if ((Slider_CompCH0_WRK & Slider_CompCH0_CMP_OUT_MASK) != cmpState)
        {
...
/*******************************************************************************
* Function Name: Slider_CompCH0_ZeroCal
********************************************************************************
*
* Summary:
...
uint16 Slider_CompCH0_ZeroCal(void) 
{
    ...
    tmpSW0 = Slider_CompCH0_SW0;
    tmpSW2 = Slider_CompCH0_SW2;
    tmpSW3 = Slider_CompCH0_SW3;

     /* Clear routing for inP, retain routing for inN */
    Slider_CompCH0_SW0 = 0x00u;
    Slider_CompCH0_SW2 = 0x00u;
    Slider_CompCH0_SW3 = tmpSW3 & (uint8)(~Slider_CompCH0_CMP_SW3_INPCTL_MASK);

    /* Preserve original configuration
     * - turn off Hysteresis
     * - set calibration bit - shorts inN to inP
    */
    tmpCR = Slider_CompCH0_CR;
    Slider_CompCH0_CR |= (Slider_CompCH0_CAL_ON | Slider_CompCH0_HYST_OFF);
    
    /* Write default low values to trim register - no offset adjust */
    /* PSoC5A */
    #if (CY_PSOC5A)
        Slider_CompCH0_TR = Slider_CompCH0_DEFAULT_CMP_TRIM;
    #endif /* CY_PSOC5A */
    
    /* PSoC3, PSoC5LP or later */
    #if (CY_PSOC3 || CY_PSOC5LP)
        Slider_CompCH0_TR0 = Slider_CompCH0_DEFAULT_CMP_TRIM;
        Slider_CompCH0_TR1 = Slider_CompCH0_DEFAULT_CMP_TRIM;
    #endif /* CY_PSOC3 || CY_PSOC5LP */
	
	/* Two phase trim - slow modes, one phase trim - for fast */ 
    if ( (Slider_CompCH0_CR & Slider_CompCH0_PWR_MODE_MASK) == Slider_CompCH0_PWR_MODE_FAST)
    {
        Slider_CompCH0_trimAdjust(0u);
    }
    else /* default to trim for fast modes */
    {
        Slider_CompCH0_trimAdjust(1u);
		Slider_CompCH0_trimAdjust(0u);
    }
   
    /* Restore Config Register */
    Slider_CompCH0_CR = tmpCR;
    
    /* Restore routing registers for inP */
    Slider_CompCH0_SW0 = tmpSW0;
    Slider_CompCH0_SW2 = tmpSW2;
    Slider_CompCH0_SW3 = tmpSW3;
    
    /* PSoC5A */
    #if (CY_PSOC5A)
        return (uint16) Slider_CompCH0_TR;
    #endif /* CY_PSOC5A */
    
    /* PSoC3, PSoC5LP or later */
    #if (CY_PSOC3 || CY_PSOC5LP)
        return ((uint16)((uint16)Slider_CompCH0_TR1 << 8u) | (Slider_CompCH0_TR0));        
    #endif /* CY_PSOC3 || CY_PSOC5LP */
}


/*******************************************************************************
* Function Name: Slider_CompCH0_LoadTrim
********************************************************************************
*
* Summary:
...
void Slider_CompCH0_LoadTrim(uint16 trimVal) 
{
    ...
    /*******************************************************************************
    * Function Name: Slider_CompCH0_PwrDwnOverrideEnable
    ********************************************************************************
    *
    * Summary:
    ...
    *******************************************************************************/
    ...
    /*******************************************************************************
    * Function Name: Slider_CompCH0_PwrDwnOverrideDisable
    ********************************************************************************
    *
    * Summary:
