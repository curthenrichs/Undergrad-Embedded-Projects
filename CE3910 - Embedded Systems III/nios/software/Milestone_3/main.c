 ...
 *	  TRACK tracks an object in the screen that is closest to the max light
 */

//todo tune tracking controller
//todo determine PWM problem
//todo add multiple filtering for tracking
//todo test in bright conditions
